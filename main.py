...
def register():
    ...
    if form.validate_on_submit():
        ...
        if user:
            flash('This email has been registered,pls log in instead')
            ...
            new_user = User(name=form.name.data,email=email,password=hash_and_salted_password)
...
#delete author here since no need info
        body=post.body
    )
